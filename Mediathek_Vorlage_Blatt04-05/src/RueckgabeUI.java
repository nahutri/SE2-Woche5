...
class RueckgabeUI
{
    ...
    private void erzeugeVerleihkartenauflister()
    {
        ...
        verleihkartenAuflisterPanel.setPreferredSize(new java.awt.Dimension(-1,
                -1));
        ...
        verleihkartenAuflisterScrollPane.setBorder(BorderFactory
                .createTitledBorder(null, "Verleihkarten",
                        TitledBorder.LEADING, TitledBorder.DEFAULT_POSITION,
                        UIConstants.HEADER_FONT));
        verleihkartenAuflisterScrollPane
                .setBackground(UIConstants.BACKGROUND_COLOR);
        verleihkartenAuflisterScrollPane.getVerticalScrollBar().setBackground(
    ...
    private void erzeugeVerleihkartenAnzeiger()
    {
        ...
        verleihkartenAnzeigerPanel.setPreferredSize(new java.awt.Dimension(-1,
                -1));
        ...
        verleihkartenAnzeigerScrollPane
                .setBackground(UIConstants.BACKGROUND_COLOR);
        verleihkartenAnzeigerScrollPane.getVerticalScrollBar().setBackground(
                UIConstants.BACKGROUND_COLOR);
        verleihkartenAnzeigerScrollPane.getHorizontalScrollBar().setBackground(
                UIConstants.BACKGROUND_COLOR);
